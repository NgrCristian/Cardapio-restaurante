...
17 Total a Pagar:${(quantidade*valor[2]).toFixed(2)}`); break; 
  
  case '4':
console.log("Produto Selecionado:${cardapio}\r\nNome do Produto:${lanche[3]}\r\nPreço Unitario:${(valor[3]).toFixed(2)} Total a Pagar:${(quantidade*valor [3]).toFixed(2)}"); break; 

  case '5':
console.log("Produto Selecionado:${cardapio}\r\nNome do Produto:${lanche[4]}\r\nPreço Unitario:${(valor[4]).toFixed(2)} Total a Pagar:${(quantidade*valor [4]).toFixed(2)}');
}
